 ...
 **/
public struct ArrayResponse<ItemType>: Array where ItemType: Resource & Decodable {
...
/**
 ...
 See: <https://www.contentful.com/developers/docs/references/content-delivery-api/#/introduction/collection-resources-and-pagination>
 */
public struct MappedArrayResponse<ItemType>: Array where ItemType: EntryDecodable {
...
extension MappedArrayResponse: Decodable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        includes        = try container.decodeIfPresent(MappedArrayResponse.Includes.self, forKey: .includes)
